...
def primer_menu ():
    pla = str(input('Ingrese el nombre de la planta(mayus): '))
    ciu = str(input('Ingrese el nombre de la ciudad(mayus): '))

    if pla == 'COCA CODO SINCLAIR' and ciu =='QUITO':
    #COCA QUITO
    ...
    elif pla == 'COCA CODO SINCLAIR' and ciu == 'GUAYAQUIL':
        #COCA GUAYAQUIL
    ...
    elif pla == 'SOPLADORA' and ciu == 'GUAYAQUIL':
    #SOPLADORA GUAYAQUIL
    ...
    elif pla == 'SOPLADORA' and ciu == 'QUITO':
    #SOPLADORA QUITO
    ...
    elif pla == 'SOPLADORA' and ciu == 'LOJA':
    #SOPLADORA LOJA
        ...
        print('¡DATOS INCORRECTOS!\nINGRESE NUEVAMENTE LOS DATOS DE LA PLANTA Y LA CIUDAD POR FAVOR')

def segundo_menu ():
    ciu = str(input('Ingrese el nombre de la ciudad(mayus): '))
    if ciu == 'QUITO':
        print('Las plantas que producen energia en esta localidad son:', plantas['Quito'])
        ...
        print('Las plantas que producen energia en esta localidad son:', plantas['Guayaquil'])
        ...
        print('¡LO SIENTO, EN ESTA CIUDAD NO SE ADMINISTRA LA ENERGIA QUE BUSCA !')
